...
### read audio data
```{r}
load("/Users/Edward/Dropbox/Vivesi2018/Analysis/Audio/Mviv17_41_calls.robj")
...
```{r}
m17_41 <- read.csv("C:/Users/Edward/Dropbox/VivesiACC/data/clean/clean_ACC_Mviv17_41.csv")
...
## get buzz times
```{r}
spec <- "C:/Users/Edward/Dropbox/VivesiAudio/BuzzCheck/Mviv17/Mviv17_41/Buzz/"
...
save(m17_41, Mv18_main, Mv18_buzz, Mv18_cons, Mviv18, Mv18_summary, 
     file = "/Users/Edward/Dropbox/Vivesi2018/Analysis/Accelerometer/data/Mviv17_41_complete.robj")
load("/Users/Edward/Dropbox/Vivesi2018/Analysis/Accelerometer/data/Mviv17_41_complete.robj")

```

# write csv
```{r}
write.csv(m17_41, file = "C:/Users/Edward/Dropbox/VivesiACC/data/clean/Audio/Mviv17_41_ACC_Call.csv")
```
